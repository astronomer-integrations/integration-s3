...
S3Integration.prototype.invoke = function(payload, fn) {
    ...
    var bucketName = this.settings.bucketName;
    var accessKeyId = this.settings.accessKeyId;
    var secretAccessKey = this.settings.secretAccessKey;
    ...
    logger.info('Uploading events for: ' + appId);
    s3Client.upload({ 
        Key: key, 
